...
Frontend/Frontend_Raspberry/frog_raspy.o: Frontend/Frontend_Raspberry/frog_raspy.c $(HDR) Frontend/Frontend_Raspberry/frog_raspy.h
	$(CC) $(CFLAGS) -c Frontend/Frontend_Raspberry/frog_raspy.c -o Frontend/Frontend_Raspberry/frog_raspy.o
